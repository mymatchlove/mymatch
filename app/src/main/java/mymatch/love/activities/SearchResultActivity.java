...
public class SearchResultActivity extends AppCompatActivity implements CommonListAdapter.ItemListener {
    ...
    private void initializeRecyclerView() {
        ...
        adapter = new CommonListAdapter(this, list);
    ...
    private void getData(int page) {
        ...
        common.makePostRequest(AppConstants.search_result + page, param, response -> {
            AppDebugLog.print("response in search result : "+response);
            common.hideProgressRelativeLayout(loader);
            try {
