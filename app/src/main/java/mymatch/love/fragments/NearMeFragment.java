...
public class NearMeFragment extends Fragment implements CommonListAdapter.ItemListener {
...
//        getListData(1);
    ...
    private void initializeRecyclerView() {
        ...
        adapter = new CommonListAdapter(requireActivity(), list);
    ...
    private void getListData(int page) {
        ...
        common.makePostRequestTime(AppConstants.search_now + page, param, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                common.hideProgressRelativeLayout(loader);
                AppDebugLog.print("near me resp : " + response);
                try {
                    ...
                    if (total_count != 0) {
                        ...
                        if (total_count != list.size()) {
                            ...
                            for (int i = 0; i < data.length(); i++) {
                                ...
                                item.setUser_id(obj.getString("id"));
    ...
    @Override
    public void blockRequest(String tag, String id) {
        common.showProgressRelativeLayout(loader);
        HashMap<String, String> param = new HashMap<>();
        param.put("matri_id", session.getLoginData(SessionManager.KEY_MATRI_ID));
        if (tag.equals("remove")) {
